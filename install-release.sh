...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/chen-ran/v2ray-sspanel-plugin/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/chen-ran/v2ray-sspanel-plugin/releases/latest"
